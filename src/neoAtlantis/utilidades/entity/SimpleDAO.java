package neoAtlantis.utilidades.entity;
...
import neoAtlantis.utilidades.entity.exceptions.ConfigurationDAOException;
...
//  m etodos implementados  -   ---------------------------------------------------------------------------------------------------------------
    ...
    /**
     * Recupero todos los elementos a partir del filtro sin paginación
     *
    ...
    /**
     * Recupero todos los elementos a partir del filtro y con el tamaño de
     * pagina por default
     *
     * @param filtro Elemento que define la clausulas de busqueda
     * @param page Página que se desa obtener, 0 para recuperar todos los
     * registros
     * @return Coleccion de objetos cargados a partir del metodo
     * 'ParseMultipleEntities'
     * @throws java.sql.SQLException
    ...
    /**
     * Recupero todos los elementos a partir del filtro con paginación
     *
     * @param filtro Elemento que define la clausulas de busqueda
     * @param page Página que se desa obtener, 0 para recuperar todos los
     * registros
     * @param pageSize Tamaño de la página a obtener
     * @return Coleccion de objetos cargados a partir del metodo
     * 'ParseMultipleEntities'
     * @throws SQLException
     */
     ...
     *
     * @param to Elemento a agregar
     * @return Valor autonumerico asignado en la operación
     * @throws java.sql.SQLException
     */
    ...
    public E parseEntity(ResultSet res) {
        throw new UnsupportedOperationException("No tiene implementación del metodo 'ParseEntity', en el Objeto: " + this.getClass());
    }
    ...
    public void asignSelectParameters(PreparedStatement query, E filtro) throws SQLException {
        throw new UnsupportedOperationException("No tiene implementación del metodo 'AsignSelectParameters', en el Objeto: " + this.getClass());
    }
    ...
    public void asignInsertParameters(PreparedStatement query, E objeto) throws SQLException {
        throw new UnsupportedOperationException("No tiene implementación del metodo 'AsignInsertParameters', en el Objeto: " + this.getClass());
    }
    ...
    public void asignUpdateParameters(PreparedStatement query, E objeto) throws SQLException {
        throw new UnsupportedOperationException("No tiene implementación del metodo 'AsignUpdateParameters', en el Objeto: " + this.getClass());
    }
    ...
    public void asignDeleteParameters(PreparedStatement query, E objeto) throws SQLException {
        throw new UnsupportedOperationException("No tiene implementación del metodo 'AsignDeleteParameters', en el Objeto: " + this.getClass());
    }
