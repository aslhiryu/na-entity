...
public class SimpleEntity  implements Serializable {
    ...
    /**
     * Obtiene la información de la constituci&oacute; propia de la clase.
     * @return
     */
    ...
    /**
     * Genera la información propia de la clase y la almacena en el cache.
     */
    ...
    public String obtieneInfo(int nivel) {
        ...
        for (List alTmp: SimpleEntity.cache.get(this.getClass())) {
            //System.out.println("Carga información para: "+alTmp.get(0));
            ...
            if( Modifier.isPublic(((Field)alTmp.get(0)).getModifiers()) ){
                try{
                    ...
                    DEBUGGER.error("Error al recuperar el atributo publico: "+((Field)alTmp.get(0)).getName(), ex);
    ...
    /*public void setPropertyValue(String property, Object value){
        //busco si existe la propiedad solicitada
    ...
    public void setPropertyStringValue(String property, String value){
        ...
        if( !found ){
            DEBUGGER.debug("No se logró asignar el valor por atributo, intento asignarlo por metodo.");
            ...
            for(Method m: ms){
                if (props!=null && props.length==1 && m.getName().equalsIgnoreCase("set"+props[0])){
                    try{
                        ...
                        DEBUGGER.error("No se logro asignar el valor por metodo", ex);
                    }
                }
            }
        }
